...
<?php echo Form::open(['url'=>'poi/actividad/reporte', 'class'=>'form-horizontal']); ?>
        ...
        <div class="form-group">
            ...
            <select name="unidad_ejecutora" id="unidad_ejecutora" class="form-control select2">
                ...
                <?php $__currentLoopData = $ejecutoras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ejecutora): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($ejecutora->id); ?>"><?php echo e($ejecutora->numero); ?>. <?php echo e($ejecutora->nombre); ?></option>
...
<?php echo $__env->make('layouts.plantillaPoi', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sgd\resources\views\poi\reporte\inicio.blade.php ENDPATH**/ ?>