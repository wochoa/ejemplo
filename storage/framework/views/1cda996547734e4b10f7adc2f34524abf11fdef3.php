    ...
    <!--4. PROGRAMACIÓN OPERATIVA POR ACTIVIDAD-->        
        ...
        <!--CUERPO 1-->
            ...
            <?php $__currentLoopData = $inversiones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inversion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr style="text-align: center">
                    <td>
                        <?php echo e($inversion->numero); ?>

                        <a style="color: black;" href="#" data-toggle="modal" data-target="#<?php echo e($i); ?>" title="Editar"><span class="glyphicon glyphicon-pencil pull-left" style="font-size: 13px;"></span></a>
                        <!-------------------------Modal------------------------------------------------------------>
                        <div class="modal fade bd-example-modal-lg" id="<?php echo e($i); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog modal-lg" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    <h4 class="modal-title text-center" id="myModalLabel">Editar Actividad Operativa:<?php echo e($inversion->numero); ?> <br><?php echo e($inversion->denominacion); ?></h4>
                                </div>
                                <?php echo Form::open(['url'=>'poi/anteproyecto/editarf2/'.$inversion->id, 'class'=>'form-horizontal']); ?>

                                <div class="modal-body">
                                    <?php echo Form::hidden('actividad_id', $inversion->id, ['class'=>'form-control', 'id'=>'actividad_id']); ?>

                                    <?php echo Form::hidden('idactividad_proyecto_edit', $id, ['class'=>'form-control', 'id'=>'idactividad_proyecto_edit']); ?>

                                    <div class="form-group">
                                        <?php echo Form::label('Denominación', null, ['class'=>'col-sm-2 control-label']); ?>

                                        <div class="col-sm-9 input-group">
                                            <textarea class="form-control" id="actividad_denominacion_edit" name="actividad_denominacion_edit" required><?php echo e($inversion->denominacion); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <?php echo Form::label('Indicador', null, ['class'=>'col-sm-2 control-label']); ?>

                                        <div class="col-sm-9 input-group">
                                            <?php echo Form::text('actividad_indicador_edit', $inversion->indicador, ['class'=>'form-control', 'required'=>'', 'id'=>'actividad_indicador_edit']); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 input-group">
                                            <?php echo Form::text('actividad_unidad_medida_edit', $inversion->um, ['class'=>'form-control', 'required'=>'', 'id'=>'actividad_unidad_medida_edit']); ?>

                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <?php echo Form::label('Descripción', null, ['class'=>'col-sm-2 control-label']); ?>

                                        <div class="col-sm-9 input-group">
                                            <textarea class="form-control" id="actividad_descripcion_edit" name="actividad_descripcion_edit" required><?php echo e($inversion->descripcion); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <?php echo Form::label('Tareas Ope.', null, ['class'=>'col-sm-2 control-label']); ?>

                                        <div class="col-sm-9 input-group">
                                            <textarea class="form-control" id="actividad_tareas_operativas_edit" name="actividad_tareas_operativas_edit" required><?php echo e($inversion->tareas); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <?php echo Form::label('Beneficiarios', null, ['class'=>'col-sm-2 control-label']); ?>

                                        <div class="col-sm-9 input-group">
                                            <?php echo Form::text('actividad_beneficiarios_edit', $inversion->beneficiarios, ['class'=>'form-control', 'required'=>'', 'id'=>'actividad_beneficiarios_edit']); ?>

                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <?php echo Form::label('Localización', null, ['class'=>'col-sm-2 control-label']); ?>

                                        <div class="col-sm-9 input-group">
                                            <?php echo Form::text('actividad_localizacion_edit', $inversion->localizacion, ['class'=>'form-control', 'required'=>'', 'id'=>'actividad_localizacion_edit']); ?>

                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <?php echo Form::label('Prioridad OEI', null, ['class'=>'col-sm-2 control-label']); ?>

                                        <div class="col-sm-9 input-group">
                                            <?php echo Form::text('actividad_prioridad_edit', $inversion->prioridad, ['class'=>'form-control', 'required'=>'', 'id'=>'actividad_prioridad_edit']); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 input-group">
                                            <?php echo Form::number('actividad_fisica_total_edit', $inversion->total, ['class'=>'form-control', 'readonly'=>'true', 'id'=>'actividad_fisica_total_edit', 'placeholder'=>'Ingrese la Cant. para cada Mes']); ?>
                                    ...
                                    <table class="table-bordered table-condensed">
                                        ...
                                        <tbody class="active2">
                                            <tr>
                                                <td><?php echo Form::text('actividad_fisica_enero_edit', ($inversion->enero)?:0, ['class'=>'form-control sumar', 'id'=>'actividad_fisica_enero_edit']); ?></td>
                                                <td><?php echo Form::text('actividad_fisica_febrero_edit', ($inversion->febrero)?:0, ['class'=>'form-control sumar', 'id'=>'actividad_fisica_febrero_edit']); ?></td>
                                                <td><?php echo Form::text('actividad_fisica_marzo_edit', ($inversion->marzo)?:0, ['class'=>'form-control sumar', 'id'=>'actividad_fisica_marzo_edit']); ?></td>
                                                <td><?php echo Form::text('actividad_fisica_abril_edit', ($inversion->abril)?:0, ['class'=>'form-control sumar', 'id'=>'actividad_fisica_abril_edit']); ?></td>
                                                <td><?php echo Form::text('actividad_fisica_mayo_edit', ($inversion->mayo)?:0, ['class'=>'form-control sumar', 'id'=>'actividad_fisica_mayo_edit']); ?></td>
                                                <td><?php echo Form::text('actividad_fisica_junio_edit', ($inversion->junio)?:0, ['class'=>'form-control sumar', 'id'=>'actividad_fisica_junio_edit']); ?></td>
                                                <td><?php echo Form::text('actividad_fisica_julio_edit', ($inversion->julio)?:0, ['class'=>'form-control sumar', 'id'=>'actividad_fisica_julio_edit']); ?></td>
                                                <td><?php echo Form::text('actividad_fisica_agosto_edit', ($inversion->agosto)?:0, ['class'=>'form-control sumar', 'id'=>'actividad_fisica_agosto_edit']); ?></td>
                                                <td><?php echo Form::text('actividad_fisica_setiembre_edit', ($inversion->setiembre)?:0, ['class'=>'form-control sumar', 'id'=>'actividad_fisica_setiembre_edit']); ?></td>
                                                <td><?php echo Form::text('actividad_fisica_octubre_edit', ($inversion->octubre)?:0, ['class'=>'form-control sumar', 'id'=>'actividad_fisica_octubre_edit']); ?></td>
                                                <td><?php echo Form::text('actividad_fisica_noviembre_edit', ($inversion->noviembre)?:0, ['class'=>'form-control sumar', 'id'=>'actividad_fisica_noviembre_edit']); ?></td>
                                                <td><?php echo Form::text('actividad_fisica_diciembre_edit', ($inversion->diciembre)?:0, ['class'=>'form-control sumar', 'id'=>'actividad_fisica_diciembre_edit']); ?></td>
                                            </tr>
                                        </tbody>                        
                                    </table>
                                </div>
        ...
        <!--CUERPO 3-->
                ...
                <tr class="text-center">
                    <td style="text-align: left;" class="active2" rowspan="2" colspan="2">      
                        <a href="<?php echo e(url('poi/anteproyecto/insumosf2/'.$id.'/'.$inversion->id)); ?>" class="btn btn-success btn-xs pull-right"><span class="glyphicon glyphicon-plus"></span> Clas.</a>
                        Actividad <?php echo e($tar); ?> : <b><?php echo e($inversion->denominacion); ?></b>                        
                    </td>
                ...
                <tr style="text-align: center">
                    <td class="active2" rowspan="2">
                        <button class="btn btn-primary btn-xs" data-toggle="modal" data-target="#tarea_modal"><i class="glyphicon glyphicon-plus"></i> Act. <?php echo e($tar); ?></button>
                        ...
                        <div class="modal fade bd-example-modal-lg" id="tarea_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog modal-lg" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                  <h4 class="modal-title" id="myModalLabel">Nueva Actividad Operativa - Inversiones <?php echo e($i); ?></h4>
                                </div>
                                <?php echo Form::open(['url'=>'poi/anteproyecto/guardarf2', 'class'=>'form-horizontal']); ?>

                                <div class="modal-body">
                                    <?php echo Form::hidden('idactividad_proyecto', $id, ['class'=>'form-control', 'id'=>'idactividad_proyecto']); ?>

                                    <?php echo Form::hidden('actividad_numero', $i, ['class'=>'form-control', 'id'=>'actividad_numero']); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 input-group">
                                            <?php echo Form::text('actividad_indicador', '', ['class'=>'form-control', 'required'=>'', 'id'=>'actividad_indicador']); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 input-group">
                                            <?php echo Form::text('actividad_unidad_medida', '', ['class'=>'form-control', 'required'=>'', 'id'=>'actividad_unidad_medida']); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 input-group">
                                            <?php echo Form::text('actividad_beneficiarios', '', ['class'=>'form-control', 'required'=>'', 'id'=>'actividad_beneficiarios']); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 input-group">
                                            <?php echo Form::text('actividad_localizacion', '', ['class'=>'form-control', 'required'=>'', 'id'=>'actividad_localizacion']); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 input-group">
                                            <?php echo Form::text('actividad_prioridad', '', ['class'=>'form-control', 'required'=>'', 'id'=>'actividad_prioridad']); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 input-group">
                                            <?php echo Form::number('actividad_fisica_total', '', ['class'=>'form-control', 'readonly'=>'true', 'id'=>'actividad_fisica_total', 'placeholder'=>'Ingrese la Cant. para cada Mes']); ?>
                                    ...
                                    <table class="table-bordered table-condensed">
                                        ...
                                        <tbody class="active2">
                                            <tr>
                                                <td><?php echo Form::text('actividad_fisica_enero', '0', ['class'=>'form-control sumar2', 'id'=>'actividad_fisica_enero']); ?></td>
                                                <td><?php echo Form::text('actividad_fisica_febrero', '0', ['class'=>'form-control sumar2', 'id'=>'actividad_fisica_febrero']); ?></td>
                                                <td><?php echo Form::text('actividad_fisica_marzo', '0', ['class'=>'form-control sumar2', 'id'=>'actividad_fisica_marzo']); ?></td>
                                                <td><?php echo Form::text('actividad_fisica_abril', '0', ['class'=>'form-control sumar2', 'id'=>'actividad_fisica_abril']); ?></td>
                                                <td><?php echo Form::text('actividad_fisica_mayo', '0', ['class'=>'form-control sumar2', 'id'=>'actividad_fisica_mayo']); ?></td>
                                                <td><?php echo Form::text('actividad_fisica_junio', '0', ['class'=>'form-control sumar2', 'id'=>'actividad_fisica_junio']); ?></td>
                                                <td><?php echo Form::text('actividad_fisica_julio', '0', ['class'=>'form-control sumar2', 'id'=>'actividad_fisica_julio']); ?></td>
                                                <td><?php echo Form::text('actividad_fisica_agosto', '0', ['class'=>'form-control sumar2', 'id'=>'actividad_fisica_agosto']); ?></td>
                                                <td><?php echo Form::text('actividad_fisica_setiembre', '0', ['class'=>'form-control sumar2', 'id'=>'actividad_fisica_setiembre']); ?></td>
                                                <td><?php echo Form::text('actividad_fisica_octubre', '0', ['class'=>'form-control sumar2', 'id'=>'actividad_fisica_octubre']); ?></td>
                                                <td><?php echo Form::text('actividad_fisica_noviembre', '0', ['class'=>'form-control sumar2', 'id'=>'actividad_fisica_noviembre']); ?></td>
                                                <td><?php echo Form::text('actividad_fisica_diciembre', '0', ['class'=>'form-control sumar2', 'id'=>'actividad_fisica_diciembre']); ?></td>
                                            </tr>
                                        </tbody>                        
                                    </table>
                                </div>
...
</html><?php /**PATH C:\xampp\htdocs\sgd\resources\views\poi\anteproyecto\formatof2\verf2.blade.php ENDPATH**/ ?>