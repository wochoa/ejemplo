            ...
            <div class="panel-group">
               <div class="panel panel-primary">
                   ...
                   <div class="panel-body" id="central">
                      <!--CUERPO-->
                      <?php echo e(Form::open(array('action' => 'Tramite\BloqueController@create','method'=>'GET', 'class' => 'form-horizontal', 'id'=>'myform'))); ?>
                      ...
                      <?php echo e(csrf_field()); ?>
                          ...
                          <div class="form-group">
                                ...
                                <div class="col-sm-6">                                
                                     <select class="form-control" name="bloque_tipo", id="bloque_tipo", onchange = 'javascript:showContent(this)'> 
                                         ...
                                         <?php else: ?>
                                            <option>---Seleccione Opción---</option>
                                            <option value="1" <?php echo e((1 == $reportes_hidd)?"selected":""); ?> >SOLO MOSTRAR MENSAJES</option>
                                            <option value="2" <?php echo e((2 == $reportes_hidd)?"selected":""); ?> >BLOQUEAR Y MOSTRAR MENSAJES</option>
                                            <option value="3" <?php echo e((3 == $reportes_hidd)?"selected":""); ?> >NO BLOQUEAR</option>
                                         <?php endif; ?>                                     
                                     </select>
                                     <?php echo e(Form::hidden('reportes_hidd', $reportes_hidd, ['id'=>'text2', 'class'=>'form-control'])); ?>
                          ...
                          <div class="form-group">
                                ...
                                <div class="col-sm-1">                            
                                    <?php echo e(Form::text('', '', ['id'=>'unidad_org_rec', 'class'=>'form-control', 'readonly'])); ?>   
                                </div>
                                <div class="col-sm-5">
                          ...
                          <div class="form-group">
                             <?php echo e(Form::label('Usuario: ', '', ['class' =>  'col-sm-3 control-label', 'for'=>'FormGroup'])); ?>
                          ...
                          <div class="form-group" style="display: block;" id="content1"> 
                            <?php echo e(Form::label('Mensaje que Mostrará: ', '', ['class' =>  'col-sm-3 control-label', 'for'=>'FormGroup'])); ?> 
                              <div class="col-sm-6">
                                 <?php echo e(Form::textarea('notes', null, ['class' => 'form-control', 'size' => '30x2'])); ?>
                          ...
                          <div class="form-group">
                            <?php echo e(Form::label('', '', ['class' =>  'col-sm-3 control-label', 'for'=>'FormGroup'])); ?>
                             ...
                             <div class="col-sm-5">                               
                                <!--<?php echo e(Form::button('<span class="glyphicon glyphicon-search"></span>',array('url'=>'bloques/create', 'id'=>'enviar','class'=>'btn btn-primary','type'=>'submit'))); ?>-->
                                 <?php echo e(Form::button('<span class="glyphicon glyphicon-floppy-save"> Registrar</span>',
...
<?php echo $__env->make('layouts.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sgd\resources\views\tramite\administracion\bloques\nuevobloque.blade.php ENDPATH**/ ?>