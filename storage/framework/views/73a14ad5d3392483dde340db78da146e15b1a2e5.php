            ...
            <tbody style="text-align: center">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <option value>--- Selecione Opción ---</option>
                        <?php $__currentLoopData = $prog_p; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($prog->id); ?>"><?php echo e($prog->id); ?>.- <?php echo e($prog->nombre); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </td>    
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php $__currentLoopData = $meta; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $met): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($met->ID); ?>"><?php echo e($met->numero); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </td>
                </tr>
...
<script type="text/javascript">
    $('input:radio[name=cat_presupuestal]').change(function () {
        ...
        /*$("#meta_pres").on("change", function(event) {
            ...
            var id = $(this).val();
            $.ajax({
              url: "<?php echo e(url('poi/metasid')); ?>",
              data: {
              dni: id
              },
              type: "POST",
...
</html><?php /**PATH C:\xampp\htdocs\sgd\resources\views\poi\formatof2\anteproyecto.blade.php ENDPATH**/ ?>