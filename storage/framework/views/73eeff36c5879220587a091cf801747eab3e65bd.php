<?php $__env->startSection('titulo'); ?><?php echo e('Detalle de Modificatoria'); ?><?php $__env->stopSection(); ?>
<?php $__env->startSection('homeText'); ?><?php echo e($modif_nombre.' ('.$modif_fecha.')'); ?><?php $__env->stopSection(); ?>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content form-group col-md-12 ">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="form-group col-xs-12 col-sm-6 col-lg-4">
                                ...
                                <?php echo e(Form::select('det_fuente_financiamiento', $fuenteFinanciamiento, null, array('class' => 'form-control send reset', 'required'=>1) )); ?>

                            </div>
                            <?php echo e(Form::label('det_id_clasif', 'Especifica')); ?>

                            <div class="form-group col-xs-12 col-sm-6 col-lg-6" style="font-size: 8px">
                                <?php echo e(Form::select('det_id_clasif', $especificas, null, array('class' => 'form-control send reset', 'required'=>1, 'multiple'=>'multiple') )); ?>
                    ...
                    <div class="form-group col-xs-12 col-sm-12">
                        ...
                        <?php echo e(Form::hidden('modificatoria_id', $modif, array('class' => 'send'))); ?>
        ...
        <div class="mod_ad_btn">
            <div class="row">
                ...
                <div class="form-group  col-xs-3 col-sm-3 col-lg-3">
                    <?php echo e(Form::select('fft', $fuenteFinanciamiento, $fft, array('class' => 'form-control change_type', 'required'=>1) )); ?>

                </div>
                <div class="form-group  col-xs-3 col-sm-3 col-lg-3">
                    <?php echo e(Form::select('tipo', [ 'APnoP'=>'ASIGNACIONES PRESUPUESTARIAS QUE NO RESULTAN EN PRODUCTOS', 'PP'=>'PROGRAMAS PRESUPUESTALES', 'all'=>'TODOS'], $opt, array('class' => 'form-control change_type', 'required'=>1) )); ?>
...
<script>
    ...
    module.saveModule({
        rList: '<?php echo e(route('proyectos.herramientas.modif.det.index',[$anio, $modif, $fft, $opt] )); ?>?option=listar',
        rDelete:'<?php echo e(route('proyectos.herramientas.modif.det.destroy',[$anio, $modif, $fft, $opt,'%s'])); ?>',
        rSave:'<?php echo e(route('proyectos.herramientas.modif.det.store',[$anio, $modif, $fft, $opt] )); ?>',
        token:'<?php echo e(csrf_token()); ?>',
        requiredFields:['modificatoria_id','componente_id'],
        afterSave:function (res) {
            r= '<?php echo e(route('proyectos.herramientas.modif.det.index',[$anio, $modif, '%x', '%y'] )); ?>';
            r = r.replace(/%x/g, res.fft);
            r = r.replace(/%y/g, res.opt);
            if(res.fft != '<?php echo e($fft); ?>' && !(res.opt == '<?php echo e($opt); ?>' || '<?php echo e($opt); ?>'=='all'))
            location.href=r
    ...
    module.find('.serach').click(function (event) {
        ...
        window.open('<?php echo e(route('proyectos.herramientas.modif.buscar',[$anio] )); ?>', 'Popup', "height=700,width=1050,scrollTo,resizable=1,scrollbars=1,location=0")
    });
    ...
    function guardarModificacion(id, pim, de, a, just) {
        $.ajax({
            url:'<?php echo e(route('proyectos.herramientas.modif.det.store',[$anio, $modif, $fft, $opt] )); ?>?option=1',
            method:'POST',
            data:{'id':id, 'pim':pim, 'de':de, 'a':a, 'justificacion':just, '_token': '<?php echo e(csrf_token()); ?>'},
            success:function (result) {
                if (result.ok){
                    module.saveModule({rList: '<?php echo e(route('proyectos.herramientas.modif.det.index',[$anio, $modif, $fft, $opt] )); ?>?option=listar',actions:'recargar',
                        afterList:afterList_
                    });
                }
                else
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.proyectos.herramientas.tab_modificar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sgd\resources\views\proyectos\herramientas\modificar\detalle\index.blade.php ENDPATH**/ ?>