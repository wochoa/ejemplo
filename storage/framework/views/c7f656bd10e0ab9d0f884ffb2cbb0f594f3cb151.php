...
<div id="myPrintArea" class="container-fluid" style="border: solid black 1px;">
    ...
    <table class="table table-bordered">
        <thead>
        <tr class="info">
            <th style="text-align: center; font-size: 9px !important;">SOLICITUD DE CERTIFICACI&Oacute;N DE CR&Eacute;DITO PRESUPUESTARIO - CERTIFICACI&Oacute;N N&deg; <u style="font-size: 1.4em;"><?php echo e(sprintf("%06s",$solicitud->solc_certificado)); ?></u></th>
        </tr>
        </thead>
    </table>
    <!--FIN TITULO-->
    ...
    <div style="float: left;">
        <table class="table table-bordered">
            ...
            <tbody>
            <tr>
                <td><?php echo e(\Carbon\Carbon::createFromFormat('Y-m-d',$documento->doc_fecha)->format('d')); ?></td>
                <td><?php echo e(\Carbon\Carbon::createFromFormat('Y-m-d',$documento->doc_fecha)->format('m')); ?></td>
                <td><?php echo e(\Carbon\Carbon::createFromFormat('Y-m-d',$documento->doc_fecha)->format('Y')); ?></td>
            </tr>
            </tbody>
        </table>
    </div>
    ...
    <table>
        ...
        <tr>
            ...
            <td style="border-top: hidden; border-right: hidden;" class="con-borde-bottom"><?php echo e($documento->doc_oficina); ?></td>
        </tr>
        </tbody>
    </table>
    ...
    <table>
        ...
        <tr>
            ...
            <td style="border-top: hidden; border-right: hidden;" class="con-borde-bottom"><?php echo e($documento->doc_documento); ?></td>
        </tr>
        </tbody>
    </table>
    ...
    <table>
        ...
        <tr>
            ...
            <td style="border: hidden;" class="sin-borde">GASTO CORRIENTE <input type="text" class="text-center" size="1" style="margin-left: 20px" value="<?php echo e(($solicitud->solc_tipo_gasto==1)?'X':''); ?>"></td>
            <td style="border: hidden;" class="sin-borde">GASTO DE CAPITAL<input type="text" class="text-center" size="1" style="margin-left: 20px" value="<?php echo e(($solicitud->solc_tipo_gasto==2)?'X':''); ?>" ></td>
        </tr>
        </tbody>
    </table>
    ...
    <table>
        ...
        <tr>
            ...
            <td style="border: hidden;" class="sin-borde"><?php echo e($solicitud->solc_objeto); ?></td>
        </tr>
        </tbody>
    </table>
    ...
    <table>
        ...
        <tr>
            ...
            <td style="border-top: hidden; border-right: hidden;" class="con-borde-bottom"><?php echo e($solicitud->solc_tipo_proceso_seleccion); ?></td>
        </tr>
        </tbody>
    </table>
    ...
    <table>
        ...
        <tr>
            ...
            <td style="border: hidden;" class="con-borde-bottom"><?php echo e($solicitud->solc_otros); ?></td>
        </tr>
        </tbody>
    </table>
    ...
    <table>
        ...
        <tr>
            <td width="20%" style="border: hidden;" class="sin-borde">OTROS</td>
            <td style="border: hidden;" class="sin-borde"><?php echo e($solicitud->solc_justificacion); ?></td>
        </tr>
        </tbody>
    </table>
    <br>
    ...
    <table>
        ...
        <tr>
            ...
            <td style="border-top: hidden; border-right: hidden;" class="con-borde-bottom"><?php echo e($solicitud->solc_doc_priorizacion); ?></td>
        </tr>
        </tbody>
    </table>
    <br>
    ...
    <table class="table table-bordered table-condensed" style="margin-bottom: 20px !important;">
        ...
        <tr>
            <td class="text-center"><?php echo e(\App\Http\Controllers\Proy\tools\cert\SolicitudC::iniciales($detalle->fuente_financiamiento_nombre)); ?></td>
            <td class="text-center"><?php echo e(sprintf("%02s",$detalle->det_fuente_financiamiento)); ?></td>
            <td class="text-center"><?php echo e(sprintf("%04s",$detalle->programa)); ?></td>
            <td class="text-center"><?php echo e(sprintf("%07s",$detalle->prod_proy)); ?></td>
            <td class="text-center"><?php echo e(sprintf("%07s",$detalle->act_al_obra)); ?></td>
            <td class="text-center"><?php echo e(sprintf("%02s",$detalle->funcion)); ?></td>
            <td class="text-center"><?php echo e(sprintf("%03s",$detalle->division_funcional)); ?></td>
            <td class="text-center"><?php echo e(sprintf("%04s",$detalle->grupo_funcional)); ?></td>
            <td class="text-center"><?php echo e(sprintf("%04s",$detalle->finalidad)); ?></td>
            <td class="text-center"><?php echo e(sprintf("%04s",$detalle->sec_func)); ?></td>
            <td class="text-center"><?php echo e($detalle->especifica); ?></td>
            <td class="text-right"><?php echo e(Money::toMoney($detalle->det_pia,'')); ?></td>
            <td class="text-right"><?php echo e(Money::toMoney($detalle->det_pim,'')); ?></td>
            <td class="text-right"><?php echo e(Money::toMoney($detalle->det_certificacion,'')); ?></td>
            <td class="text-right"><?php echo e(Money::toMoney($detalle->det_pim-$detalle->det_certificacion,'')); ?></td>
            <td class="text-right"><?php echo e(Money::toMoney($detalle->det_monto_solicitado,'')); ?></td><?php $total+=$detalle->det_monto_solicitado?>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <tr>
            <td colspan="15" class="total sin-borde" style="border-bottom: hidden; border-left: hidden;"></td>
            <td class="text-right"><?php echo e(Money::toMoney($total,'')); ?></td>
        </tr>
        </tbody>
    </table>
    <table class="sellos">
...
<?php echo $__env->make('layouts.proyectos.reporte', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sgd\resources\views\proyectos\herramientas\certificar\solicitud\imprimir.blade.php ENDPATH**/ ?>