...
<!----------------------------------------------------------------------------------------------------------------->
        ...
        <table class="table table-bordered table-condensed">    
            ...
            <tbody>
                <tr>
                    ...
                    <td style="text-align: center"><?php echo e($unidadejecutoras->codunieje); ?></td>
                    <td style="text-align: center"><?php echo e($unidadejecutoras->nombreejecutora); ?></td>
                    <td class="active"><b>1.2. Año</b></td>
                    <td style="text-align: center"><?php echo e($unidadejecutoras->anio1); ?></td>
                </tr>
            </tbody>
        </table>
        ...
        <table class="table table-bordered table-condensed">    
            ...
            <tbody>
                <tr>
                    ...
                    <td style="text-align: center"><?php echo e($mision->mision); ?></td>
                    <td class="active"><b>2.2. Misión Institucional</b></td>
                    <td style="text-align: center"><?php echo e($vision->vision); ?></td>
                </tr>
            </tbody>
        </table>
    ...
    <!--3. PROGRAMACIÓN OPERATIVA POR ACTIVIDAD-->        
        ...
        <!--CUERPO 1-->                             
                ...
                <?php $__currentLoopData = $organicas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $organica): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($unidadorganica->numorden == $organica->orden): ?>
                    <?php ($cont++); ?> 
                <tr style="text-align: center">                   
                    <?php if($cont==1): ?>
                        <td rowspan="<?php echo e($unidadorganica->conteo + 1); ?>"><?php echo e($unidadorganica->numorden); ?></td>
                        <td rowspan="<?php echo e($unidadorganica->conteo + 1); ?>"><?php echo e($unidadorganica->nombreunidad); ?></td>
                    <?php endif; ?>                    
                    <td>(Unidad Responsable de la Actividad)</td>
                    <td><?php echo e($organica->codigoact); ?></td>
                    <td><?php echo e($organica->nombreact); ?></td>
                    <td><?php echo e($organica->nombreind); ?></td>
                    <td><?php echo e($organica->nombreum); ?></td>                    
                    <td> - </td>
                    <td> - </td>                    
                    <td> - </td>
                    <td> - </td>                    
    ...
    <!--4. PROGRAMACIÓN OPERATIVA DE LA UNIDAD EJECUTORA-->        
        ...
        <!--CUERPO 1-->
                <tr style="text-align: center">
                    <td><?php echo e($unidadejecutoras->codunieje); ?>.- <?php echo e($unidadejecutoras->nombreejecutora); ?></td>                   
                    <td> - </td>
                    <td>(Financiera)</td>                    
                    <td> - </td>
                    <td>(Financiera)</td>                    
...
<!--FORMATO F2: PROGRAMACIÓN OPERATIVA DE LA ACTIVIDAD/PROYECTO-->    
    ...
    <!--TITULO-->
        <table class="table table-bordered">
            <thead>
                <tr bgcolor="#98CCF4">
                    <th style="text-align: center" width="100%">FORMATO F-2: PROGRAMACIÓN OPERATIVA DE LA ACTIVIDAD/PROYECTO - ACTIVIDAD N° <?php echo e($cout); ?></th>
                </tr>
            </thead>            
        </table>
    <!--FIN TITULO-->
        ...
        <table class="table table-bordered table-condensed">    
            ...
            <tbody>
                <tr>
                        ...
                        <td width="14%" style="text-align: center"><?php echo e(strtoupper($unidadejecutoras->codunieje.'.- '.$unidadejecutoras->nombreejecutora)); ?></td>
                        <td width="10%" class="active"><b>1.2. Unidad Orgánica</b></td>
                        <td width="37%" style="text-align: center"><?php echo e(strtoupper($unidadejecutoras->uniorganica)); ?></td>
                        <td width="10%" class="active"><b>1.3. Año</b></td>
                        <td width="37%" style="text-align: center"><?php echo e($unidadejecutoras->anio1); ?></td>
                </tr>
            </tbody>
        </table>
    <!--FIN 1. INFORMACIÓN GENERA--> 
        ...
        <table class="table table-bordered table-condensed" width="100%">    
            ...
            <tbody style="text-align: center">
                <tr>
                    ...
                    <td colspan="2"><?php echo e($mision->mision); ?></td>
                    <td class="active"><b>2.2. Misión Institucional</b></td>
    ...
    <!--3. ARTICULACIÓN PRESUPUESTARIA-->     
        <table class="table table-bordered table-condensed">    
            ...
            <tbody style="text-align: center">
                ...
                <tr>
                    <?php if($poi->categoria != 9001 && $poi->categoria != 9002): ?>
                        <td><?php echo e($poi->categoria); ?></td>    
                ...
                <tr>
                    <td><?php echo e($poi->funcion); ?></td>
                    <td><?php echo e($poi->division); ?></td>
                    <td><?php echo e($poi->grupo); ?></td>
                    <td><?php echo e($poi->categoria); ?></td>
                    <td><?php echo e($poi->producto); ?></td>
                    <td><?php echo e($poi->obra); ?></td>
                    <td><?php echo e($poi->finalidad); ?></td>
                    <td><?php echo e($poi->meta); ?></td>
                </tr>
            </tbody>
        </table>
    ...
    <!--4. PROGRAMACIÓN OPERATIVA POR ACTIVIDAD-->        
        ...
        <!--CUERPO 1-->
            <?php $__currentLoopData = $tareas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tarea): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr style="text-align: center">
                    <td><?php echo e(strtoupper($unidadejecutoras->uniorganica)); ?></td>
                    <td><?php echo e($tarea->idact); ?></td>
                    <td colspan="4"><?php echo e($tarea->nomact); ?></td>
                    <td colspan="3"><?php echo e($tarea->indact); ?></td>
                    <td colspan="2"><?php echo e($tarea->medact); ?></td>
                    <td colspan="2">(Valor de la Meta)</td>
                    <td colspan="2">(Monto Financ.)</td>
                    <?php if( $tarea->fueact1 == 1): ?>
                        <td><b> x </b></td>
                    <?php else: ?>
                        <td><b></b></td>
                    <?php endif; ?>
                    <?php if( $tarea->fueact2 == 2): ?>
                        <td><b> x </b></td>
                    <?php else: ?>
                        <td><b></b></td>
                    <?php endif; ?>
                    <?php if( $tarea->fueact3 == 3): ?>
                        <td><b> x </b></td>
                    <?php else: ?>
                        <td><b></b></td>
                    <?php endif; ?>
                    <?php if( $tarea->fueact4 == 4): ?>
                        <td><b> x </b></td>
                    <?php else: ?>
                        <td><b></b></td>
                    <?php endif; ?>
                    <?php if( $tarea->fueact5 == 5): ?>
                        <td><b> x </b></td>
                    <?php else: ?>
                        <td><b></b></td>
                    <?php endif; ?>
        ...
        <!--CUERPO 3-->
                ...
                <!--------------------------------------------------->
                <tr style="text-align: center">
                    <td class="active" rowspan="2"><b>Act<?php echo e($cout++); ?>: </b>Actividad 1</td>
...
</html><?php /**PATH C:\xampp\htdocs\sgd\resources\views\poi\reportef2.blade.php ENDPATH**/ ?>