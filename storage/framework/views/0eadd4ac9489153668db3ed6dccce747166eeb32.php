...
<div class="container-fluid">
    ...
    <table class="table modif" style="padding: 15px; border: black 1px solid !important;">
        <thead style="display: table-header-group">
            ...
            <tr class="sin-borde">
                <th colspan="9" class="text-center"><h4><?php echo e($modificatoria->modif_titulo); ?></h4></th>
            </tr>
            <tr class="sin-borde">
                <th class="text-left subtitle">PLIEGO</th>
                <th colspan="8" class="text-left subtitle">: 448 GOBIERNO REGIONAL CUSCO</th>
            </tr>
            <tr class="sin-borde">
                <th class="text-left subtitle">FTE. DE FTO.</th>
                <th colspan="8" class="text-left subtitle">: <?php echo e($fuenteFinanciamiento); ?> - <?php echo e($tipo); ?></th>
            </tr>
            <tr class="info">
        ...
        <?php $__currentLoopData = $modificaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proyecto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td class="text-right"><?php echo e(Money::toMoney($proyecto['modif']->acumulado,'')); ?></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.proyectos.reporte', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sgd\resources\views\proyectos\herramientas\modificar\detalle\imprimir_general.blade.php ENDPATH**/ ?>