...
<div class="container-fluid">
    ...
    <table class="table modif" style="padding: 15px; border: black 1px solid !important;">
        <thead style="display: table-header-group">
            ...
            <tr class="sin-borde">
                <th colspan="11" class="text-center"><h4><?php echo e($modificatoria->modif_titulo); ?></h4></th>
            </tr>
            <tr class="sin-borde">
                <th colspan="2" class="text-left subtitle">PLIEGO</th>
                <th colspan="9" class="text-left subtitle">: 448 GOBIERNO REGIONAL CUSCO</th>
            </tr>
            <tr class="sin-borde">
            ...
            <tr class="sin-borde">
                ...
                <th colspan="9" class="text-left subtitle">: <?php echo e($fuenteFinanciamiento); ?> - <?php echo e($tipo); ?></th>
            </tr>
            <tr class="info">
        ...
        <tbody><?php $count=1?>
        <?php $__currentLoopData = $modificaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id =>$proyecto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td class="text-center"><?php echo e($count++); ?></td>
                <td class="text-center"><?php echo e($proyecto['modif']->comp_prod_proy); ?></td>
                <td class="text-justify"><?php echo e($proyecto['modif']->proy_nombre); ?></td>
                <td class="text-right"><?php echo e(Money::toMoney($proyecto['modif']->proy_pip_actualizado,'')); ?></td>
                <td class="text-right"><?php echo e(Money::toMoney($proyecto['modif']->acumulado+$proyecto['modif']->proy_ejecucion_otras_ejecutoras,'')); ?></td>
                <td class="text-right"><?php echo e(Money::toMoney($proyecto['modif']->proy_pip_actualizado-$proyecto['modif']->acumulado,'')); ?></td>
                <td class="text-right"><?php echo e(Money::toMoney($proyecto['modif']->pim_proy,'')); ?></td>
                <td class="text-right" <?php echo e(($proyecto['d']['de']>0)?'style=color:red!important;':''); ?>><?php echo e(Money::toMoney(($proyecto['d']['de']>0)?($proyecto['d']['de']*-1):0,'')); ?></td>
                <td class="text-right"><?php echo e(Money::toMoney($proyecto['d']['a'],'')); ?></td>
                <td class="text-right"><?php echo e(Money::toMoney(($proyecto['modif']->pim_proy+($proyecto['d']['a']-$proyecto['d']['de'])),'')); ?></td>
                <td class="text-justify"><?php echo e($proyecto['modif']->det_justificacion); ?></td>
            </tr>
        ...
        <tr class="info">
            ...
            <td class="text-right" <?php echo e(($total['de']>0)?'style=color:red!important;':''); ?>><?php echo e(Money::toMoney(($total['de']>0)?($total['de']*-1):0,'')); ?></td>
            <td class="text-right"><?php echo e(Money::toMoney($total['a'],'')); ?></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.proyectos.reporte', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sgd\resources\views\proyectos\herramientas\modificar\detalle\imprimir_proyectos.blade.php ENDPATH**/ ?>