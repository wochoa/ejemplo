...
<script>
    $(function() {
        ...
        table.DataTable({
            processing: true,
            serverSide: true,
            ajax: '<?php echo route('proyectos.herramientas.modif.buscar',[$anio ]); ?>?listar=1',
            columns: [
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.proyectos.herramientas.tab_buscar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sgd\resources\views\proyectos\herramientas\modificar\buscar\index.blade.php ENDPATH**/ ?>