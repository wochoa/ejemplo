...
<!--FORMATO F2: PROGRAMACIÓN OPERATIVA DE LA ACTIVIDAD/PROYECTO-->
            ...
            <tbody style="text-align: center">   
                ...
                @foreach($insumos AS $insumo)
                    <tr>
                        ...
                        <td>                            
                            <?php echo e($insumo->clasificador->cg_descripcion); ?>

                        </td>
                        <td>
                            <a href="#" data-toggle="modal" data-target="#<?php echo e($insumo->id); ?>" title="Editar - <?php echo e($insumo->id); ?>"><span class="glyphicon glyphicon-pencil text-center" style="font-size: 11px; color: black; padding-bottom:10px;"></span></a>
                        <!-------------------------Modal------------------------------------------------------------>
                            <div class="modal fade bd-example-modal-lg" id="<?php echo e($insumo->id); ?>" tabindex="1" role="dialog" aria-labelledby="myModalLabel">
                                <div id="editinsumo">
                                <div class="modal-dialog modal-lg" role="document">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                      <h4 class="modal-title" id="myModalLabel" style="text-align: center"><b>EDITAR: Insumo N° <?php echo e($ins); ?></b></h4>
                                    </div>
                                    <?php echo Form::open(['url'=>'poi/anteproyecto/editarinsumos/'.$insumo->id, 'class'=>'form-horizontal']); ?>

                                    <?php echo e(csrf_field()); ?>

                                    <div class="modal-body">
                                        <?php echo Form::hidden('especifica_id_actividad_actividad_edit', $inv, ['class'=>'form-control', 'id'=>'especifica_id_actividad_actividad_edit']); ?>

                                        <?php echo Form::hidden('especifica_id_actividad_proyecto_edit', $act, ['class'=>'form-control', 'id'=>'especifica_id_actividad_proyecto_edit']); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9 input-group">
                                                <?php echo Form::text('especifica_unidad_medida_edit', $insumo->um, ['class'=>'form-control', 'required'=>'', 'placeholder'=>'Ingrese la Unid. de Medida', 'id'=>'especifica_unidad_medida_edit']); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9 input-group">
                                                <?php echo Form::number('especifica_cantidad_edit', $insumo->cantidad, ['class'=>'form-control', 'required'=>'', 'placeholder'=>'Ingrese la Cantidad(Insumo)', 'id'=>'especifica_cantidad_edit']); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9 input-group">
                                                <?php echo Form::number('especifica_monto_total_edit', $insumo->monto, ['class'=>'form-control', 'id'=>'especifica_monto_total_edit', 'placeholder'=>'Ingrese el Monto para cada mes', 'readonly']); ?>
                            ...
                            <?php echo e(csrf_field()); ?>
                                ...
                                <a href="<?php echo e(url('poi/anteproyecto/deleteinsumos/'.$act.'/'.$inv.'/'.$insumo->id)); ?>" title="Eliminar"><span class="glyphicon glyphicon-trash del" style="font-size: 11px; color: black;"></span></a>
                            <?php echo Form::close(); ?>

                        <br><br>
                        </td>
                        <td><?php echo e($insumo->um); ?></td>
                ...
                <tr class="success2">
                    ...
                    <td></td>
                    <td><b><?php echo e($totalins->total_cantidad); ?></b></td>
    ...
    <!--FIN 3. ARTICULACIÓN PRESUPUESTARIA-->         
        <div>
            <a href="<?php echo e(url('poi/anteproyecto/f2/'.$act)); ?>" class="btn btn-primary"><i class="glyphicon glyphicon-fast-backward"></i> Atras</a> 
            ...
            <div class="modal fade bd-example-modal-lg texto-modal" id="adinsumo" tabindex="1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                      <h5 class="modal-title" id="myModalLabel" style="text-align: center"><b>Agregar Insumo a la Actividad: </b><br><?php echo e($inversion->denominacion); ?></h5>
                    </div>
                    <?php echo Form::open(['url'=>'poi/anteproyecto/guardarinsumosf2', 'class'=>'form-horizontal']); ?>

                    <div class="modal-body">
                        <?php echo Form::hidden('especifica_id_actividad_proyecto', $act, ['class'=>'form-control', 'id'=>'especifica_id_actividad_proyecto']); ?>

                        <?php echo Form::hidden('especifica_id_actividad_actividad', $inv, ['class'=>'form-control', 'id'=>'especifica_id_actividad_actividad']); ?>
                        ...
                        <table class="table-bordered table-condensed">
                            ...
                            <tbody class="success2">
                                <tr>
                                    <td><?php echo Form::text('esp_enero', '0.00', ['class'=>'form-control suma2', 'id'=>'esp_enero']); ?></td>
                                    <td><?php echo Form::text('esp_febrero', '0.00', ['class'=>'form-control suma2', 'id'=>'esp_febrero']); ?></td>
                                    <td><?php echo Form::text('esp_marzo', '0.00', ['class'=>'form-control suma2', 'id'=>'esp_marzo']); ?></td>
                                    <td><?php echo Form::text('esp_abril', '0.00', ['class'=>'form-control suma2', 'id'=>'esp_abril']); ?></td>
                                    <td><?php echo Form::text('esp_mayo', '0.00', ['class'=>'form-control suma2', 'id'=>'esp_mayo']); ?></td>
                                    <td><?php echo Form::text('esp_junio', '0.00', ['class'=>'form-control suma2', 'id'=>'esp_junio']); ?></td>
                                    <td><?php echo Form::text('esp_julio', '0.00', ['class'=>'form-control suma2', 'id'=>'esp_julio']); ?></td>
                                    <td><?php echo Form::text('esp_agosto', '0.00', ['class'=>'form-control suma2', 'id'=>'esp_agosto']); ?></td>
                                    <td><?php echo Form::text('esp_setiembre', '0.00', ['class'=>'form-control suma2', 'id'=>'esp_setiembre']); ?></td>
                                    <td><?php echo Form::text('esp_octubre', '0.00', ['class'=>'form-control suma2', 'id'=>'esp_octubre']); ?></td>
                                    <td><?php echo Form::text('esp_noviembre', '0.00', ['class'=>'form-control suma2', 'id'=>'esp_noviembre']); ?></td>
                                    <td><?php echo Form::text('esp_diciembre', '0.00', ['class'=>'form-control suma2', 'id'=>'esp_diciembre']); ?></td>
                                </tr>
                            </tbody>                        
                        </table>
                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\sgd\resources\views\poi\anteproyecto\formatof2\insumosf2.blade.php ENDPATH**/ ?>