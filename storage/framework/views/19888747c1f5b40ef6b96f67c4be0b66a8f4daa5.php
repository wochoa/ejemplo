    ...
    <script>
        $(function() {
            ...
            table.DataTable({
                processing: true,
                serverSide: true,
                ajax: '<?php echo e(route('proyectos.herramientas.{anio}.modificar.index',[$anio] )); ?>?datatable=1',
                columns: [
    ...
    </script><?php /**PATH C:\xampp\htdocs\sgd\resources\views\proyectos\herramientas\modificar\modificatorias\listar.blade.php ENDPATH**/ ?>