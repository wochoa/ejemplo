...
<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-analitico" width="100%">
    ...
    <tbody>
        ...
        foreach($analitico as $d)
        {
            ...
            ?>
                <?php if($componente!=$dato->ana_componente): ?>
                    <tr class="<?php echo e(($subtotal>=(isset($ejecucion[$componente])?$ejecucion[$componente]['monto']:0))?'info':'alert-danger'); ?>">
                        <td colspan="2  ">Total : <?php echo e($componente_text. ' ('.$componente.')'); ?></td>
                        <td class="text-right border-left"><?php echo e(Money::toMoney($subtotal,'')); ?></td>
                        <td class="text-right"><?php echo e(Money::toMoney($subtotal_modif,'')); ?></td>
                        <td class="text-right border-right"><?php echo e(Money::toMoney($subtotal+$subtotal_modif,'')); ?></td>
                        <td class="text-right"><?php echo e(Money::toMoney((isset($ejecucion[$componente])?$ejecucion[$componente]['monto']:0),'')); ?></td>
                        <td class="text-right"><?php echo e(Money::toMoney($subtotal+$subtotal_modif-(isset($ejecucion[$componente])?$ejecucion[$componente]['monto']:0),'')); ?></td>
                        <td></td>
                    </tr>
                ...
                $total_e+=$ejecutado;
                ?>
                    <tr <?php echo e((!$isclass)?'style=color:red;':''); ?>>
                        <td><?php echo (isset($espeficicas[$dato->ana_especifca]))?$espeficicas[$dato->ana_especifca]:$elemento[$dato->ana_especifca].'         <strong>(Clasificador antiguo)</strong'; ?></td>
                        <td><?php echo e($dato->ana_descricion); ?></td>
                        <td class="text-right border-left"><?php echo e(Money::toMoney($dato->ana_monto,'')); ?></td>
                        <td class="text-right"><?php echo e(Money::toMoney($dato->ana_modificaciones,'')); ?></td>
                        <td class="text-right border-right"><?php echo e(Money::toMoney($dato->ana_monto+$dato->ana_modificaciones,'')); ?></td>
                        <td class="text-right"><?php echo e(Money::toMoney($ejecutado,'')); ?></td>
                        <td class="text-right"><?php echo e(Money::toMoney($dato->ana_monto+$dato->ana_modificaciones-$ejecutado,'')); ?></td>
        ...
        <tr class="info">
            ...
            <td class="text-right border-right"><?php echo e(Money::toMoney($subtotal+$subtotal_modif,'')); ?></td>
            <td class="text-right"><?php echo e(Money::toMoney(isset($ejecucion[$componente])?$ejecucion[$componente]['monto']:0,'')); ?></td>
            <td><?php echo e(Money::toMoney($subtotal+$subtotal_modif-(isset($ejecucion[$componente])?$ejecucion[$componente]['monto']:0),'')); ?></td>
            <td></td>
        </tr>
        <?php
            $total_i+=$subtotal;
        ...
        <tr class="info">
            ...
            <td class="text-right border-left"><?php echo e(Money::toMoney($total_i,'')); ?></td>
            <td class="text-right"><?php echo e(Money::toMoney($total_m,'')); ?></td>
            <td class="text-right border-right"><?php echo e(Money::toMoney($total_i+$total_m,'')); ?></td>
            <td class="text-right"><?php echo e(Money::toMoney($total_e,'')); ?></td>
            <td class="text-right"><?php echo e(Money::toMoney($total_i+$total_m-$total_e,'')); ?></td>
            <td></td>
        </tr>
        <?php
        } else {?>
        ...
        <tr class="">
            ...
            <td colspan="2" style="border-right:none;"><?php echo e(Money::toMoney($proyecto->proy_pip_actualizado)); ?></td>
            <td colspan="2">&nbsp;</td>
        </tr>
        <tr class="">
        ...
        <tr class="">
            ...
            <td colspan="2" style="border-right:none;"><?php echo e(Money::toMoney($total_e)); ?></td>
            <td colspan="2">&nbsp;</td>
        </tr>
        <tr class="">
            <td colspan="4">Total Ejecutado OTRAS UNIDADES EJECUTORAS.</td>
            <td colspan="2" style="border-right:none;"><?php echo e(Money::toMoney($proyecto->proy_ejecucion_otras_ejecutoras)); ?></td>
            <td colspan="2">&nbsp;</td>
        </tr>
        <tr class="<?php echo e(($proyecto->proy_pip_actualizado-$proyecto->proy_ejecucion_otras_ejecutoras>=$total)?'':'alert-danger'); ?>">
            <td colspan="4">Saldo por programar.</td>
            <td colspan="2" style="border-right:none;"><?php echo e(Money::toMoney($proyecto->proy_pip_actualizado-$proyecto->proy_ejecucion_otras_ejecutoras-$total)); ?></td>
            <td colspan="2">&nbsp;</td>
        </tr>
        <tr class="<?php echo e(($total>=$total_e)?'active':'alert-danger'); ?>">
            <td colspan="4">Saldo por Ejecutar.</td>
            <td colspan="2" style="border-right:none;"><?php echo e(Money::toMoney($total-$total_e)); ?></td>
            <td colspan="2">&nbsp;</td>
        </tr>
    </tbody>
</table><?php /**PATH C:\xampp\htdocs\sgd\resources\views\proyectos\analitico\list.blade.php ENDPATH**/ ?>