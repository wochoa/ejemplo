    ...
    <div class="form-body" id="cnt_modulo" style="text-align: center;">
        <div class="row">
            ...
            <div class="form-group col-xs-12 col-sm-12 col-lg-12">
                <?php echo e(Form::label('cnt_nombre', 'NOMBRE')); ?>

                <?php echo e(Form::text('cnt_nombre', '', array('class' => 'form-control send verif', 'placeholder' => 'contrato') )); ?>

            </div>

            <div class="form-group col-xs-4 col-sm-4 col-lg-4">
                    <?php echo e(Form::label('cnt_dni', 'DNI')); ?>

                    <?php echo e(Form::text('cnt_dni', '', array('class' => 'form-control send verif', 'placeholder' => 'contrato') )); ?>

            </div>

            <div class="form-group col-xs-8 col-sm-8 col-lg-8">
                    <?php echo e(Form::label('cnt_direccion', 'DIRECCION')); ?>

                    <?php echo e(Form::text('cnt_direccion', '', array('class' => 'form-control send verif', 'placeholder' => 'contrato') )); ?>

            </div>

            <div class="form-group col-xs-6 col-sm-6 col-lg-6">
                    <?php echo e(Form::label('cnt_cargo', 'CARGO')); ?>

                    <?php echo e(Form::select('cnt_cargo',[''=>'SELECCIONE', '9'=>'ASISTENTE TECNICO DE INSPECTOR', '10'=>'ASISTENTE TECNICO DE RESIDENTE', '11'=>'AUXILIAR ADMINISTRATIVO', '12'=>'ING CIVIL DE CAMPO'], '', array('class' => 'form-control send verif') )); ?>

                    <?php echo e(Form::hidden('cnt_cargo_txt', null, array('class' => 'send') )); ?>

            </div>

            <div class="form-group col-xs-3 col-sm-3 col-lg-3">
                <?php echo e(Form::label('cnt_finicio', 'INICIO')); ?>

                <?php echo e(Form::date('cnt_finicio', ''  , array('class' => 'form-control send verif') )); ?>

            </div>

            <div class="form-group col-xs-3 col-sm-3 col-lg-3">
                <?php echo e(Form::label('cnt_ffin', 'FIN')); ?>

                <?php echo e(Form::date('cnt_ffin', ''  , array('class' => 'form-control send verif') )); ?>

            </div>

            <div class="form-group col-xs-1 col-sm-1 col-lg-1">
            <?php echo e(Form::label('cnt_proced', 'OFICINA')); ?><br>
             <?php echo e(Form::text('cnt_procednro', '47', array('class' => 'form-control') )); ?>

            </div>

            <div class="form-group col-xs-8 col-sm-8 col-lg-8"><br>
             <?php echo e(Form::select('cnt_proced', [''=>'OFICINA'], null, array('class' => 'form-control send') )); ?>

             <?php echo e(Form::hidden('cnt_proced_nombre', null, array('class' => 'form-control send') )); ?>

            </div>

            <div class="form-group col-xs-3 col-sm-3 col-lg-3">
                <?php echo e(Form::label('cnt_expe_sisgedo', 'EXP SISGEDO')); ?>

                <?php echo e(Form::number('cnt_expe_sisgedo', '', array('class' => 'form-control send verif reset'))); ?>

            </div>

            <div class="form-group col-xs-3 col-sm-3 col-lg-3">
               <?php echo e(Form::label('cnt_ref1', 'REF1')); ?>

               <?php echo e(Form::select('cnt_ref1', [''=>'SELECCIONE'], null, array('class' => 'form-control send ref') )); ?>

            </div>

            <div class="form-group col-xs-3 col-sm-3 col-lg-3">
               <?php echo e(Form::label('cnt_ref2', 'REF2')); ?>

               <?php echo e(Form::select('cnt_ref2', [''=>'SELECCIONE'], null, array('class' => 'form-control send ref') )); ?>

            </div>

            <div class="form-group col-xs-3 col-sm-3 col-lg-3">
               <?php echo e(Form::label('cnt_ref3', 'REF3')); ?>

               <?php echo e(Form::select('cnt_ref3', [''=>'SELECCIONE'], null, array('class' => 'form-control send ref') )); ?>

            </div>

            <div class="form-group col-xs-3 col-sm-3 col-lg-3">
               <?php echo e(Form::label('cnt_ref4', 'REF4')); ?>

               <?php echo e(Form::select('cnt_ref4', [''=>'SELECCIONE'], null, array('class' => 'form-control send ref') )); ?>

            </div>

            <div class="form-group col-xs-12 col-sm-12 col-lg-12">
                    <?php echo e(Form::label('cnt_obra', 'OBRA')); ?>

                    <?php echo e(Form::textarea('cnt_obra', null, array('class' => 'form-control send', 'size' => '30x2') )); ?>

                    <?php echo e(Form::hidden('cnt_idobra', null, array('class' => 'send') )); ?>

            </div>

            <div class="form-group col-xs-4 col-sm-4 col-lg-4">
               <?php echo e(Form::label('cnt_meta', 'META')); ?>

               <?php echo e(Form::select('cnt_meta', [''=>'SELECCIONE'], null, array('class' => 'form-control send') )); ?>

            </div>

            <div class="form-group col-xs-4 col-sm-4 col-lg-4">
                <?php echo e(Form::label('cnt_ff', 'FUENTE DE FINANCIAMIENTO')); ?>

                <?php echo e(Form::select('cnt_ff', [''=>'SELECCIONE'], null,array('class' => 'form-control send') )); ?>

            </div>

            <div class="form-group col-xs-4 col-sm-4 col-lg-4">
                <?php echo e(Form::label('cnt_especifica', 'ESPECIFICA')); ?>

                <?php echo e(Form::select('cnt_especifica', [''=>'SELECCIONE'], null, array('class' => 'form-control send') )); ?>

            </div>

            <div class="form-group col-xs-9 col-sm-9 col-lg-9">
                <?php echo e(Form::label('cnt_cfp', 'CADENA FUNCIONAL')); ?>

                <?php echo e(Form::text('cnt_cfp', '' , array('class' => 'form-control send verif') )); ?>

            </div>

            <div class="form-group col-xs-3 col-sm-3 col-lg-3">
                <?php echo e(Form::label('cnt_monto', 'MONTO')); ?>

                <?php echo e(Form::text('cnt_monto', '', array('class' => 'form-control send verif reset'))); ?>
...
<script>
    ...
    $( document ).ready(function() {
        Loadoficinas(
            "http://www.regionCUSCO.gob.pe/portal/proyectos/json/sisgedo_request.php",
            {depe:'3'},
            $("[name='cnt_proced']"),
            '47'
            );
    ...
    $('#datatable').on("click",'.return',function(event){event.preventDefault();
        ...
        Loadmeta(
            "<?php echo e(route('proyectos.herramientas.documento.buscarMeta',[$anio])); ?>",
            $(this).data('data'),
            $("[name='cnt_meta']")
        );
    ...
    $("#cnt_modulo").on("change",'#cnt_meta',function(event){
        Loadff(
            "<?php echo e(route('proyectos.herramientas.documento.buscarFf', [$anio])); ?>",
            {sec_func :$(this).find('option:selected').data('data')},
            $("[name='cnt_ff']")
        );
        Loadespecifica(
            "<?php echo e(route('proyectos.herramientas.documento.buscarEsp', [$anio])); ?>",
            {sec_func :$(this).find('option:selected').data('data')},
            $("[name='cnt_especifica']")
        );
        Loadcf(
            "<?php echo e(route('proyectos.herramientas.documento.buscarCf',[$anio])); ?>",
            {sec_func :$(this).find('option:selected').data('data')},
            $("[name='cnt_cfp']")
        );
    ...
    $("#cnt_modulo").on("click",'.btn_guardar',function(event){
        form = $('.send');
            ...
            if(check) {
               var id;
                $.ajax({
                    url: "<?php echo e(route('proyectos.herramientas.documento.savecnt')); ?>",
                    data: form.serialize(),
                    dataType: 'json',
                    success: function(e){
                        if(e.ok){
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.proyectos.plantilla_proyectos', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sgd\resources\views\proyectos\herramientas\documentos\nuevoContratoForm.blade.php ENDPATH**/ ?>