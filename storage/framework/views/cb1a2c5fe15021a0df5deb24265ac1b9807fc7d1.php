        ...
        <div class="row">
            ...
            <!--fintapmenu-->
              <!--<form class="form-horizontal" action="../usuarios" method="POST">-->
				  <?php echo e(Form::open(array('action' => 'Poi\AnteproyectoFormatoF2@create_actividad'))); ?>

					<?php echo e(csrf_field()); ?>

					<?php echo e(Form::hidden('codigo', '40')); ?>

					<?php echo e(Form::submit('Agregar Actividad', array('class'=>'btn btn-primary'))); ?>
            ...
            <div class="panel-group">
               <div class="panel panel-primary">
					...
					<table class="table table-bordered table-condensed">    
						...
						<tbody>
							<tr>
								...
								<td width="37%" style="text-align: center">(Nombre de la Unidad Orgánica) <?php echo e($id_poi); ?></td>
					...
					<table class="table table-bordered table-condensed" width="100%">    
						...
						<tbody style="text-align: center">
							...
							<tr>
								...
								<td colspan="2">
									<?php echo e(Form::select('sel_cei', $ces, null, [ 'id' => 'sel_cei', 'class' => 'form-control', 'required' => 'required' ] )); ?>
							...
							<tr>
								...
								<td colspan="2">
									<?php echo e(Form::select('sel_oet', ['placeholder'=>'Seleccione'], null, [ 'id' => 'sel_oet', 'class' => 'form-control', 'required' => 'required' ] )); ?>

								</td>
								<td>
									<?php echo e(Form::select('sel_oet_indicador', ['placeholder'=>'Seleccione'], null, [ 'id' => 'sel_oet_indicador', 'class' => 'form-control', 'required' => 'required' ] )); ?>

								</td>
								<td>
									<?php echo e(Form::select('sel_oet_unidad_medida', ['placeholder'=>'Seleccione'], null, [ 'id' => 'sel_oet_unidad_medida', 'class' => 'form-control', 'required' => 'required' ] )); ?>

								</td>
								<td>
									<?php echo e(Form::text('plan_det_id', '', [ 'id' => 'plan_det_id', 'class' => 'form-control', 'required' => 'required' ] )); ?>

									<?php echo e(Form::label('meta_oet', '', [ 'id' => 'meta_oet', 'class' => 'form-control'])); ?>
							...
							<tr>
								...
								<td colspan="2">
									<?php echo e(Form::select('sel_aet', ['placeholder'=>'Seleccione'], null, [ 'id' => 'sel_aet', 'class' => 'form-control', 'required' => 'required' ] )); ?>

								</td>
								<td>
									<?php echo e(Form::select('sel_aet_indicador', ['placeholder'=>'Seleccione'], null, [ 'id' => 'sel_aet_indicador', 'class' => 'form-control', 'required' => 'required' ] )); ?>

								</td>
								<td>
									<?php echo e(Form::select('sel_aet_unidad_medida', ['placeholder'=>'Seleccione'], null, [ 'id' => 'sel_aet_unidad_medida', 'class' => 'form-control', 'required' => 'required' ] )); ?>

								</td>
								<td>
									<?php echo e(Form::text('plan_det_id_aet', '', [ 'id' => 'plan_det_id_aet', 'class' => 'form-control', 'required' => 'required' ] )); ?>

									<?php echo e(Form::label('meta_aet', '', [ 'id' => 'meta_aet', 'class' => 'form-control'])); ?>
							...
							<tr>
								...
								<td colspan="2">
									<select name="" class="form-control" required>
										...
										<option value="<?php echo e($oei->plan_det_id); ?>"><?php echo e($oei->plan_det_codigo.'. '.$oei->plan_det_descripcion); ?></option>
							...
							<tr>
								...
								<td colspan="2">
									<?php echo e(Form::select('sel_aei', ['placeholder'=>'Seleccione'], null, [ 'id' => 'sel_aei', 'class' => 'form-control', 'required' => 'required' ] )); ?>
				...
				<!--3. ARTICULACIÓN PRESUPUESTARIA-->     
					<table class="table table-bordered table-condensed">    
						...
						<tbody style="text-align: center">
							...
							<tr>
								<td><?php echo e(Form::radio('categoria_presupuestal', '9001', false, [ "id"=>"cat_pres_9001", "required" => "required"] )); ?>

									<?php echo e(Form::label('cat_pres_9001','9001')); ?>
							...
							<tr>
								<td>
									<?php echo e(Form::radio('categoria_presupuestal', '9002', false, [ "id"=>"cat_pres_9002", "required" => "required"] )); ?>

									<?php echo e(Form::label('cat_pres_9002','9002')); ?>
							...
							<tr>
								<td><?php echo e(Form::radio('categoria_presupuestal', '0000', false, [ "id"=>"cat_pres_0000", "required" => "required"] )); ?>

									<?php echo e(Form::label('cat_pres_0000','0000')); ?></td>    
								<td colspan="3">
									<?php echo e(Form::select('sel_cat_pres', $prog_pres, null, [ 'id' => 'sel_cat_pres', 'class' => 'form-control', 'required' => 'required' ] )); ?>
							...
							<tr>
								<td>
									<?php echo e(Form::select('sel_aei', ['placeholder'=>'Seleccione'], null, [ 'id' => 'sel_funcion', 'class' => 'form-control art_pres', 'required' => 'required' ] )); ?>

								</td>
								<td>
									<?php echo e(Form::select('sel_aei', ['placeholder'=>'Seleccione'], null, [ 'id' => 'sel_div_funcional', 'class' => 'form-control art_pres', 'required' => 'required'] )); ?>

								</td>
								<td>
									<?php echo e(Form::select('sel_aei', ['placeholder'=>'Seleccione'], null, [ 'id' => 'sel_grupo_funcional', 'class' => 'form-control art_pres', 'required' => 'required' ] )); ?>

								</td>
								<td>
									<?php echo e(Form::select('sel_aei', ['placeholder'=>'Seleccione'], null, [ 'id' => 'sel_cat_pres', 'class' => 'form-control art_pres', 'required' => 'required' ] )); ?>

								</td>
								<td>
									<?php echo e(Form::select('sel_aei', ['placeholder'=>'Seleccione'], null, [ 'id' => 'sel_prod_proy', 'class' => 'form-control art_pres', 'required' => 'required' ] )); ?>

								</td>
								<td>
									<?php echo e(Form::select('sel_aei', ['placeholder'=>'Seleccione'], null, [ 'id' => 'sel_act_obra', 'class' => 'form-control art_pres', 'required' => 'required' ] )); ?>

								</td>
								<td>
									<?php echo e(Form::select('sel_aei', ['placeholder'=>'Seleccione'], null, [ 'id' => 'sel_finalidad', 'class' => 'form-control art_pres', 'required' => 'required' ] )); ?>

								</td>
								<td>
									<?php echo e(Form::select('meta_presupuestaria', $meta_presupuestaria, null, [ 'id' => 'sel_meta_presupuestaria', 'class' => 'form-control', 'required' => 'required' ] )); ?>
				...
				<!--4. PROGRAMACIÓN OPERATIVA POR ACTIVIDAD-->        
					...
					<!--CUERPO 1-->
							<tr style="text-align: center">
								<td><?php echo e(Form::select('sel_unidad_responsable',['placeholder'=>'Seleccione'], null, ['required'=>'required'] )); ?></td>
								<!--<td>(De la Actv)</td>-->
								<td colspan="4"><?php echo e(Form::text('act_proy_denominacion','',["required"=>"required","readonly"=>"readonly"])); ?></td>
								<td colspan="3"><?php echo e(Form::text('act_proy_indicador','',["required"=>"required"])); ?></td>
								<td colspan="2"><?php echo e(Form::text('act_proy_unidad_medida','',["required"=>"required"])); ?></td>
								<td colspan="2"><?php echo e(Form::text('act_proy_cantidad','',["required"=>"required"])); ?></td>
								<td colspan="2">(Monto Financ.)</td>
								<td><b> <?php echo e(Form::checkbox('act_proy_ff_1','1',false)); ?> </b></td>
								<td><b> <?php echo e(Form::checkbox('act_proy_ff_2','2',false)); ?> </b></td>
								<td><b> <?php echo e(Form::checkbox('act_proy_ff_3','3',false)); ?> </b></td>
								<td><b> <?php echo e(Form::checkbox('act_proy_ff_4','4',false)); ?> </b></td>
								<td><b> <?php echo e(Form::checkbox('act_proy_ff_5','5',false)); ?> </b></td>
							</tr> 
					<!--FIN CUERPO 1-->
					...
					<!--CUERPO 2-->
							...
							<tr style="text-align: center">
								<td colspan="2"><?php echo e(Form::label('act_proy_denominacion','',["id"=>"act_proy_nombre"])); ?></td>
								<td colspan="6"> <?php echo e(Form::textarea('act_proy_descripcion','',["required"=>"required"])); ?> </td>
								<td colspan="3"> <?php echo e(Form::textarea('act_proy_localizacion','',["required"=>"required"])); ?> </td>
								<td colspan="3"> <?php echo e(Form::textarea('act_proy_beneficiarios','',["required"=>"required"])); ?> </td>
								<td colspan="4"> <?php echo e(Form::textarea('act_proy_est_oper','',["required"=>"required"])); ?> </td>
								<td colspan="2"> - </td>
							</tr> 
					<!--FIN CUERPO 2-->
                   ...
                   <div class="panel-body">
                      <!--CUERPO-->
                          ...
                          <div class="form-group">
								<?php echo e(Form::label('Proceso de Selección:* ', '', ['class' =>  'col-sm-3 control-label'])); ?>
						  ...
						  <div class="form-group">
                             ...
                             <div class="col-sm-7">
                                 <?php echo e(Form::submit('Guardar Datos del Puesto', ['class' => 'btn btn-success ' ] )); ?>
...
<?php echo $__env->make('layouts.plantillaPoi', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sgd\resources\views\poi\anteproyecto\formatof2.blade.php ENDPATH**/ ?>