               ...
               <div class="panel panel-primary">
                   ...
                   <div class="panel-body">
                      ...
                      <form class="form-horizontal">
                        <?php echo e(link_to_action('Poi\AnteproyectoFormatoF2@create_actividad', 'Nueva Actividad', array(40) )); ?>
...
<caption><h3>LISTA DE ACTIVIDADES/PROYECTOS</h3></caption>
    ...
    <tbody>
        ...
        <tr class="gradeU <?php //echo $clase_color ?>" >
            <td class="enlace" id="<?php echo e($actividad->idactividad_proyecto); ?>?>" ><?php echo e($actividad->act_proy_unidad_organica); ?></td>
            <td class="enlace" id="<?php echo e($actividad->idactividad_proyecto); ?>" ><?php echo e($actividad->act_proy_denominacion); ?></td>
            <td class="enlace" id="<?php echo e($actividad->idactividad_proyecto); ?>" ><?php echo e($actividad->act_proy_indicador); ?></td>
            <td class="enlace" id="<?php echo e($actividad->idactividad_proyecto); ?>" ><?php echo e($actividad->act_proy_um); ?></td>
            <td class="enlace" id="<?php echo e($actividad->idactividad_proyecto); ?>" ><?php echo e($actividad->idactividad_proyecto); ?></td>
            <!--<td ><?php  ?></td>
            <td><?php  ?></td>
            <td ><?php ?></td>
            <td ><?php  ?></td>
...
<?php echo $__env->make('layouts.plantillaPoi', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sgd\resources\views\poi\poiActividad.blade.php ENDPATH**/ ?>