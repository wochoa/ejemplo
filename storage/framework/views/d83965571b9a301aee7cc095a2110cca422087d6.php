...
<script>
    $(function() {
        ...
        table.DataTable({
            processing: true,
            serverSide: true,
            ajax: '<?php echo e(route('proyectos.herramientas.documento.buscar')); ?>?listar=1',
			columns: [
    ...
    <?php /**PATH C:\xampp\htdocs\sgd\resources\views\proyectos\herramientas\documentos\buscar\index.blade.php ENDPATH**/ ?>