<?php $__currentLoopData = $gastos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id=>$d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php ($lvl=$class.'-'.$id); ?>
<tr class="gradeU lvl_6 <?php echo e($lvl); ?>" data-level="<?php echo e($nivel); ?>" data-status="0" data-class="<?php echo e($lvl); ?>">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td style="text-align:right"><?php if($d->monto_dev>0): ?>
            <button type="button" class="ejec_plus btn btn-xs btn-link glyphicon glyphicon-plus"></button>
        <?php endif; ?>
    </td>
    <td colspan="10">
        <strong>Compromiso:</strong> <?php echo e($d->compromiso); ?><br>
        <strong>Monto:</strong> <?php echo e(Money::toMoney($d->monto_comp)); ?><br>
    ...
    <td><?php echo e(($d->monto_comp>0)?Money::toMoney($d->monto_comp-$d->monto_dev,''):''); ?></td>
    <td style="border-right: solid #000 2px;"><?php echo e(($d->monto_comp>0)?Money::porcentaje($d->monto_dev/$d->monto_comp):''); ?></td>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH C:\xampp\htdocs\sgd\resources\views\proyectos\proyecto\gastos\linealvl6.blade.php ENDPATH**/ ?>