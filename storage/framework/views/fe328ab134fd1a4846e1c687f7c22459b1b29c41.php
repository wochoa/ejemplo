<?php $__env->startSection('titulo'); ?><?php echo e('Ejecucion ('.$anio.')'); ?><?php $__env->stopSection(); ?>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a href="<?php echo e(route('proyectos.reporte.siaf', array('anio' => $anio))); ?>" class="navbar-brand" style="color: white;">EJECUCION <?php echo e($anio); ?></a>
            </div>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li <?php echo e(($a==$anio)?'class=active':''); ?>><a href="<?php echo e(route('proyectos.reporte.siaf', array('anio' => $a))); ?>" data-oficina="0"><?php echo e($a); ?></a></li>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?php $__currentLoopData = $resumen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id=>$dato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3 resumen" id="<?php echo e($id); ?>">
                        <div class="panel <?php echo e($dato['class']); ?>">
                            <?php if(isset($dato['color'])): ?>
                            <div class="panel-heading chng_progress" data-show="<?php echo e($id); ?>" data-color="<?php echo e($dato['color']); ?>">
                            <?php else: ?>
                                    <div class="panel-heading">
                            <?php endif; ?>
                                <div class="row">
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4" style="padding: 0 5px;"><div class="pres_titulo"><?php echo e($dato['titulo']); ?></div></div>
                                    <?php if(isset($dato['color'])): ?>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 resumen" id="meses">
                        <div class="progress">
                            <?php $__currentLoopData = ["Ene", "Feb", "Mar", "Abr", "May", "Jun","Jul", "Ago", "Set", "Oct", "Nov", "Dic"]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="progress-bar progress-bar-info" role="progressbar" style="width:8.333%"><?php echo e($mes); ?></div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                </div>
...
<?php $__env->startPush('scripts'); ?>
            <!--<?php echo Html::script('/js/reporteSiaf.js'); ?>-->
<script>
    ...
    $(document).ready(function (e) {
        ...
        function loadOficina(reload) {
            ...
            $.ajax({
                method: "GET",
                url: "<?php echo e(route('proyectos.reporte.siaf')); ?>",
                data: {anio: "<?php echo e($anio); ?>", option: "prog_vs_ejecutado",oficina: oficina, obras:obra, diario:detalle_diario.is(':checked')},
                dataType: 'json'
            }).done(loadProgramadoVsEjecutado);
            $.ajax({
                method: "GET",
                url: "<?php echo e(route('proyectos.reporte.siaf')); ?>",
                data: {anio: "<?php echo e($anio); ?>", option: "general",oficina: oficina, obras:obra},
                dataType: 'json'
            }).done(function (msg) {
                data = msg;
            ...
            if(reload)
                if (dt==null){
                    dt = $('#obras-table').DataTable({
                        processing: true,
                        serverSide: true,
                        ajax: '<?php echo e(route('proyectos.reporte.siaf')); ?>?option=listado&oficina='+oficina+'&anio=<?php echo e($anio); ?>&obras='+obra,
                        displayLength: 10,
                        columns: [
                    ...
                    dt.ajax.url('<?php echo e(route('proyectos.reporte.siaf')); ?>?option=listado&oficina='+oficina+'&anio=<?php echo e($anio); ?>&obras='+obra).load();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.proyectos.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sgd\resources\views\proyectos\reporteSiaf\index.blade.php ENDPATH**/ ?>