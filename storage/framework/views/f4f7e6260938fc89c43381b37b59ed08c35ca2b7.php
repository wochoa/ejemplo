...
<body>
    <header id="app">
        <nav class="navbar navbar-gorehco navbar-static-top" role="navigation">
            <div class="navbar-header">                
                <a href="<?php echo e(route('principal')); ?>" class="navbar-brand"><?php echo e(env('TITULO_PAGINA')); ?></a>
            </div>
        ...
        <!--<ul class="nav nav-tabs">
            <li role="presentation">
                <a href="<?php echo e(route('principal')); ?>"><?php echo e(env('TITULO_PAGINA')); ?></a>
            </li>
    ...
    <script src="<?php echo e(mix('js/controversia.js')); ?>"></script>
</body>
</html><?php /**PATH C:\xampp\htdocs\sgd\resources\views\controversia\controversia.blade.php ENDPATH**/ ?>