...
<div id="myPrintArea" class="container-fluid" style="border: solid black 1px;">
    ...
    <table class="table table-bordered">
        <thead>
        <tr class="info">
            <th style="text-align: center">SOLICITUD DE CERTIFICACI&Oacute;N DE CR&Eacute;DITO PRESUPUESTARIO - CRETIFICACI&Oacute;N N&deg; <u><?php echo e(sprintf("%06s",$solicitud->solc_certificado)); ?></u></th>
        </tr>
        </thead>
    </table>
    <!--FIN TITULO-->
    ...
    <table>
        ...
        <tr>
            ...
            <td style="border-top: hidden; border-right: hidden;" class="con-borde-bottom"><?php echo e($solicitud->solc_oficina); ?></td>
        </tr>
        </tbody>
    </table>
    ...
    <table>
        ...
        <tr>
            ...
            <td style="border-top: hidden; border-right: hidden;" class="con-borde-bottom"><?php echo e($solicitud->solc_documento); ?></td>
        </tr>
        </tbody>
    </table>
    ...
    <table class="table table-bordered table-condensed" style="margin-bottom: 100px !important;">
        ...
        <tr>
            ...
            <td class="text-center"><?php echo e(sprintf("%02s",$solicitud->solc_fuente_financiamiento)); ?></td>
            <td class="text-center"><?php echo e(sprintf("%04s",$solicitud->programa)); ?></td>
            <td class="text-center"><?php echo e(sprintf("%07s",$solicitud->prod_proy)); ?></td>
            <td class="text-center"><?php echo e(sprintf("%07s",$solicitud->act_al_obra)); ?></td>
            <td class="text-center"><?php echo e(sprintf("%02s",$solicitud->FUNCION)); ?></td>
            <td class="text-center"><?php echo e(sprintf("%03s",$solicitud->division_funcional)); ?></td>
            <td class="text-center"><?php echo e(sprintf("%04s",$solicitud->grupo_funcional)); ?></td>
            <td class="text-center"><?php echo e(sprintf("%04s",$solicitud->FINALIDAD)); ?></td>
            <td class="text-center"><?php echo e(sprintf("%04s",$solicitud->META)); ?></td>
            <td class="text-center">2.6.2.2.3.4</td>
            <td class="text-right"><?php echo e(Money::toMoney($solicitud->solc_pia,'')); ?></td>
            <td class="text-right"><?php echo e(Money::toMoney($solicitud->solc_pim,'')); ?></td>
            <td class="text-right"><?php echo e(Money::toMoney($solicitud->solc_certificacion,'')); ?></td>
            <td class="text-right"><?php echo e(Money::toMoney($solicitud->solc_pim-$solicitud->solc_certificacion,'')); ?></td>
            <td class="text-right"><?php echo e(Money::toMoney($solicitud->solc_monto_solicitado,'')); ?></td>
        </tr>
        <tr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.proyectos.reporte', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sgd\resources\views\proyectos\herramientas\certificar\imprimir.blade.php ENDPATH**/ ?>