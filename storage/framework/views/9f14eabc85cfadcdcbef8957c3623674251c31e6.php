...
<?php use Carbon\Carbon; ?>
    <div class="form-body" id="sisgedo_modulo" style="text-align: center;">
		<div class="form-group col-xs-4 col-sm-4 col-lg-4">
             <?php echo e(Form::date('s_fechainicio', ''  , array('class' => 'form-control send verif') )); ?>

   		</div>
   		<div class="form-group col-xs-4 col-sm-4 col-lg-4">
             <?php echo e(Form::date('s_fechafin', ''  , array('class' => 'form-control send verif') )); ?>

   		</div>
   		<div class="form-group col-xs-4 col-sm-4 col-lg-4">
   			<?php echo e(Form::button('Buscar', array('type' => 'button', 'class' => 'btn btn-warning small btn_buscar'))); ?>

            <?php echo e(Form::button('Imprimir', array('type' => 'button', 'class' => 'btn btn-danger small btn_imprimir'))); ?>
...
$("#sisgedo_modulo").on("click",'.btn_buscar',function(event){
  var tbody = $(".rep");
	$.ajax({
    url: "http://www.regionCUSCO.gob.pe/portal/proyectos/json/sisgedo_reporte.php",
...
<?php echo $__env->make('layouts.proyectos.plantilla_proyectos', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sgd\resources\views\proyectos\herramientas\documentos\reporte_sisgedo.blade.php ENDPATH**/ ?>