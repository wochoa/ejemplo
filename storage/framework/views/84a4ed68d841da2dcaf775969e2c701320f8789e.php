...
<script>
    $('#solicitudes_module').saveModule({
        rList: '<?php echo e(route('proyectos.herramientas.certificar.list',['proy'=>$proy,'anio'=>$anio])); ?>?listar=1',
        ...
        rPrint:"<?php echo e(route('proyectos.herramientas.certificar.show',['proy'=>$proy,'anio'=>$anio,'id'=>'%s'])); ?>",
        token:'<?php echo e(csrf_token()); ?>'

    });
    $(document).ready(function () {
        $('.print').click(function () {
            rute="<?php echo e(route('proyectos.herramientas.certificar.show',['proy'=>$proy,'anio'=>$anio,'id'=>'%s'])); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.proyectos.herramientas.tab_certificar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sgd\resources\views\proyectos\herramientas\certificar\solicitudes.blade.php ENDPATH**/ ?>