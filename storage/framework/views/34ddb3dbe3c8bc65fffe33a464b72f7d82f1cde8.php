...
?>
    <div class="form-body" id="reporte_modulo" style="text-align: center;">
      <div class="form-group col-xs-3 col-sm-3 col-lg-3">
             <?php echo e(Form::select('rep_tipo', $tipo , '14' , array('class' => 'form-control send verif') )); ?>

      </div>
		  <div class="form-group col-xs-3 col-sm-3 col-lg-3">
             <?php echo e(Form::date('rep_fechainicio', ''  , array('class' => 'form-control send verif') )); ?>

   		</div>
   		<div class="form-group col-xs-3 col-sm-3 col-lg-3">
             <?php echo e(Form::date('rep_fechafin', ''  , array('class' => 'form-control send verif') )); ?>

   		</div>
   		<div class="form-group col-xs-2 col-sm-2 col-lg-2">
   			<?php echo e(Form::button('Buscar', array('type' => 'button', 'class' => 'btn btn-warning small btn_buscar'))); ?>
...
<script>
  $("#reporte_modulo").on("click",'.btn_buscar',function(event){
        ...
        table.DataTable({
            processing: true,
            serverSide: false,
      ajax: '<?php echo e(route('proyectos.herramientas.documento.nuevoReporte')); ?>?listar=1&tipo='+$("[name='rep_tipo']").val()+'&fini'+$("[name='rep_fechafin']").val()+'&ffin='+$("[name='doc_proced_cod']").val(),
      columns: [
...
<?php echo $__env->make('layouts.proyectos.plantilla_proyectos', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sgd\resources\views\proyectos\herramientas\documentos\reporte.blade.php ENDPATH**/ ?>