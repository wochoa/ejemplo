    ...
    public function run()
    {
        ...
        DB::table('tram_dependencia')->insert([
            [
                ...
                'depe_abreviado'        => 'UFTI',
                'depe_sigla'            => 'UFTI',
                'depe_representante'    => 'KATERING Y. INGUZA LASTRA',
                'depe_cargo'            => 'RESPONSABLE',
                'depe_dni'              => '46181970',
                'depe_depende'          => 1,
                'depe_superior'         => '{"dependencia":2,"nombre":"SUB GERENCIA DE MODERNIZACION TECNOLOGIAS DE INFORMACION"}',
                'depe_tipo'             => 1,
                'depe_proyectado'       => 1,
                'depe_estado'           => 1,
                'depe_idusuario'        => 1,
