<template>
  <div>
    ...
    <div class="Dashboard u-wrapper">
      ...
      <h2 class="page-header text-center">SISTEMAS DIGITALES</h2>


      <div class="d-flex flex-wrap">
        <div v-if="routes['administrador.administrador.administrador'].can" class="col-6 col-md-3 text-center pb-3">
        ...
        <div v-if="false && routes['proyectoPresupuesto.inicio'].can" class="col-6 col-md-3 text-center">
        ...
        <div v-if="routes['mpv.view'].can" class="col-6 col-md-3 text-center">
        ...
        <div v-if="routes['interoperabilidad.view'].can" class="col-6 col-md-3 text-center">
          <a :href="routes['interoperabilidad.view'].route" class="text-secondary">
            <span class="icon icon-cog fs-72" aria-hidden="true"></span>
            <div class="h4">Interoperabilidad</div>
          </a>
        </div>

        <!-- <div v-if="routes['normatividad.view'].can" class="col-6 col-md-3 text-center">
          <a href="http://proyectos.regionCUSCO.gob.pe/normatividad" target="_blank" class="text-info">
            <span class="icon icon-files-empty fs-72" aria-hidden="true"></span>	
            <p>Normatividad</p>
          </a>
        </div> -->

        <!-- <div v-if="routes['proyectos.list'].can" class="col-6 col-md-3 text-center">
          <a href="http://proyectos.regionCUSCO.gob.pe/proyectos" target="_blank" class="text-dark">
            <span class="icon icon-usd fs-72" aria-hidden="true"></span>	
            <p>Proyectos</p>
          </a>
        </div> -->
        ...
        <!-- <div class="col-6 col-md-3 text-center">
          <a href="http://gore179.1.145.12/ticket" target="_blank" class="Dark">
