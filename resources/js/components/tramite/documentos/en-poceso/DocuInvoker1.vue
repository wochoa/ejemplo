                            ...
                            <div class="row">
                                <div class="col-sm-4" style="background-color: #3c3c3c;">
                                    ...
                                    <div class="form-group mt-4">                                        
                                        <div class="alert" role="alert" style="background: #222222!important;">
                                            <strong>Para firmar en páginas de documento!</strong> <br></br>Seleccione la hoja del pdf, luego digite la página correspondiente
                                        </div>
                                    </div>
                                    <div class="form-group mt-4 ">
                                        <label class="text-secondary">Digite la página a firmar</label>
                                        <input type="number" class="form-control form-control-sm" v-model="paginadoc" min="1">
                                    </div>
                                    
                                    <div class="form-group mt-4 mb-5">
                                        <label class="text-secondary">Motivo de la firma</label>
...
export default {
    ...
    methods: {
        ...
        previsualizapdf(idfile, iddoc) {
            ...
            this.rutaarchivo = 'http://sgd.test/' + url + '.pdf'
            // axios.get(url).then(response => {
            //     this.rutaarchivo = response.data+'.pdf'
            // })
            //var new_url = 'image2.svg';
            // $('#graph').attr('data', this.rutaarchivo);
            // $('#graph').load(this.rutaarchivo);
            

            //this.rutaarchivo = 'http://sgd.test/' + url + '.pdf#toolbar=0'
