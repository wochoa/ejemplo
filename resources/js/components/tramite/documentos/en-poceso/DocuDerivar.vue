        ...
        <form action="" @submit.prevent="derivar()">
            <div class="form-group" style="width: 100%;">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-2">
                        <!--id-->
                        <input v-model="formData.oper_depeid_d" type="text" class="form-control" @change="verificarUsuariosforDerivar()" />
                    </div>
                    <div class="col-sm-7">
                        <el-select v-model="formData.oper_depeid_d" size='mini' required @change="verificarUsuariosforDerivar()" filterable placeholder="Unidades o Dependencias" style="width: 100%;">
                            <el-option v-for="(unidad, indexUnidad) in unidadesOrganicas" :key="indexUnidad" :label="recortetexto(unidad.depe_nombre)" :value="unidad.iddependencia">
                            </el-option>
                        </el-select>
              ...
              >
                ...
                <div v-show="formData.oper_manual" :class="{ 'col-sm-12': true, 'has-error': errors.has('Destinatario') }">
                    ...
                    <div class="col-sm-9">
                        <input ref="detalle de proveido" v-model="formData.oper_persona" v-validate="'max:150'" name="Destinatario" type="text" class="form-control" @change="formData.oper_persona = formData.oper_persona.toUpperCase()" />
                ...
                <div v-show="formData.oper_manual" :class="{ 'col-sm-12': true, 'has-error': errors.has('Cargo') }">
                    ...
                    <div class="col-sm-9">
                        <input ref="detalle de proveido" v-model="formData.oper_cargo" v-validate="'max:150'" name="Cargo" type="text" class="form-control" @change="formData.oper_cargo = formData.oper_cargo.toUpperCase()" />
                ...
                <div :class="{ 'col-sm-12': true, 'has-error': errors.has('detalle de proveido') }">
                    ...
                    <div class="col-sm-9">
                        <input ref="detalle de proveido" v-model="formData.oper_detalledestino" v-validate="'max:150'" name="detalle de proveido" type="text" class="form-control" @change="formData.oper_detalledestino = formData.oper_detalledestino.toUpperCase()" />
                ...
                <div :class="{ 'col-sm-12': true, 'control-label': true, 'has-error': errors.has('proveido') }">
                    ...
                    <div class="col-sm-9">
                        <textarea ref="proveido" v-model="formData.oper_acciones" v-validate="'max:450'" name="proveido" required class="form-control" rows="2" @change="formData.oper_acciones = formData.oper_acciones.toUpperCase()"></textarea>
                    ...
                    <table id="tabla" class="table table-striped table-bordered table-condensed table-hover" style="overflow-x:scroll;">
                        ...
                        <tbody>
                            ...
                            <tr v-for="(derivacion, index1) in derivaciones" :key="index1">
                                ...
                                <td>
                                    <a class="btn btn-danger" @click="eliminarDerivacion(index1)"><span class="glyphicon glyphicon-trash"></span></a>
                                    <br />
                                    <label v-if="generado" class="control-label" style="font-weight:500; width: 90px;">
                                        <input v-if="!derivacion.oper_manual" v-model="derivacion.oper_es_destino" type="checkbox" /> Es destino.</label>
                                </td>
