            ...
            <form action="" @submit.prevent="buscarUsuario()">
                <div class="row form-group" style="width: 100%;margin-left: -0px;">
                    ...
                    <div class="col-sm-2">
                        ...
                        <input v-model="formData.adm_email" type="text" class="form-control" @change="formData.adm_email = formData.adm_email.toUpperCase()" />
                    </div>
                    <div class="col-sm-3">
                        <label for="FormGroup">Nombre:</label>
                        <input v-model="formData.adm_name" type="text" class="form-control" placeholder="Buscar" @change="formData.adm_name = formData.adm_name.toUpperCase()" />
                    </div>
                    <div class="col-sm-3">
                        <label for="FormGroup">Apellido:</label>
                        <input v-model="formData.adm_lastname" type="text" class="form-control" placeholder="Buscar" @change="formData.adm_lastname = formData.adm_lastname.toUpperCase()" />
                    </div>
                </div>
                <div class="panel-group">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="row form-group" style="width: 100%;margin-left: -0px;">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <el-select  v-model="formData.depe_nombre" @change="buscarUsuario()" filterable placeholder="Unidades o Dependencias" style="width: 100%;"
                                    size="small">
                                    ...
                                    <!-- <select v-model="formData.depe_nombre" class="form-control" @change="buscarUsuario()">
                                        ...
                                        <option v-for="(uni, indexUni) in getUnidadesDependenciaForCorrelativo(tipoUsuarios)" :key="indexUni" :value="uni.iddependencia">{{ uni.depe_nombre }}</option>
                                    </select> -->
                                </div>
                                <div class="col-sm-1">
                                    <br />
                        ...
                        <tbody>
                            <tr v-for="(user, index) in users.data" :key="index">
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-sm btn-success" title="Restablecer contraseña" @click="restablecerContrasenia(user.id)"><span class="glyphicon glyphicon-flash"></span></a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
