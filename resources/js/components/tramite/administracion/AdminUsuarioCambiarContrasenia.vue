                ...
                <div class="panel-body">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div :class="{ 'col-sm-9': true, 'has-error': errors.has('dni') }">
                            <input ref="dni" v-model="formData.adm_dni" v-validate="'required|numeric|digits:8'" type="text" name="dni" class="form-control" @change="validarDNI()" />
                        ...
                        <div :class="{ 'col-sm-9': true, 'has-error': errors.has('email') }">
                            <input ref="email" v-model="formData.adm_correo" v-validate="'required|email'" name="email" type="email" class="form-control" />
                        ...
                        <div :class="{ 'col-sm-9': true, 'has-error': errors.has('ntelf') }">
                            <input ref="ntelf" v-model="formData.adm_telefono" v-validate="'required|numeric|digits:9'" type="text" name="ntelf" class="form-control" />
                        ...
                        <div :class="{ 'col-sm-9': true, 'has-error': errors.has('contrasenia') }">
                            <input ref="contrasenia" v-model="adm_password" v-validate="'required'" type="password" name="contrasenia" class="form-control" />
                        ...
                        <div :class="{ 'col-sm-9': true, 'has-error': errors.has('confirmar_contraseña') }">
                            <input v-model="confirmPassword" v-validate="'required|confirmed:contrasenia'" type="password" class="form-control" name="confirmar_contraseña" data-vv-as="contrasenia" />
